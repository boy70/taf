...
import { Home, Users, Award, Settings, LogOut, Menu, X, Briefcase, Bell, MessageSquare, Zap } from "lucide-react"
  ...
  const navItems = [
    {
      ...
      icon: Home,
      description: "Feed & tasks",
    },
    {
      label: "Posts",
      href: "/dashboard/employee/posts",
      icon: MessageSquare,
